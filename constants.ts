...
export const LIBRARY_CATEGORIES: ResourceCategory[] = [
  {
    id: 'artigos-revistas',
  ...
  },
  {
    ...
    description: 'Livros e PDFs disponíveis para download.',
    icon: 'fa-book-open',
    subTypes: ['Livros', 'PDFs'],
    items: [
      {
        id: 'book-1',
        ...
        category: 'Livro',
        subType: 'Livros',
        description: 'Anarquismo / Política - 1892',
        type: 'PDF',
        url: 'https://drive.proton.me/urls/7120YAVQQR#F8ndHz8rHAji'
      },
      {
        id: 'book-2',
        title: 'Dom Casmurro',
        ...
        category: 'Livro',
        subType: 'Livros',
        description: 'Romance psicológico / Realismo - 1899',
        type: 'PDF',
        url: 'https://drive.proton.me/urls/WJ9QD7CMYR#ZgEL7VPCsWbD'
      },
      {
        id: 'book-3',
        title: 'Iracema',
        ...
        category: 'Livro',
        subType: 'Livros',
        description: 'Romance indianista / Nacionalismo - 1865',
        type: 'PDF',
        url: 'https://drive.proton.me/urls/GH0RHQZ8EW#T6f8fFItH3mk'
      },
      {
        id: 'book-4',
        title: 'Vidas Secas',
        ...
        category: 'Livro',
        subType: 'Livros',
        description: 'Romance social / Regionalismo - 1938',
        type: 'PDF',
        url: 'https://drive.proton.me/urls/EYM26VSWNM#7cxa6UVq7Rsz'
      },
      {
        id: 'book-5',
        title: 'Os Maias',
        ...
        category: 'Livro',
        subType: 'Livros',
        description: 'Romance realista / Crítica social - 1888',
        type: 'PDF',
        url: 'https://drive.proton.me/urls/CGPY0Y4FDG#MQptE8VRfRnd'
      },
      {
        id: 'book-6',
        ...
        category: 'Livro',
        subType: 'Livros',
        description: 'Manifesto político / Socialismo - 1848',
        type: 'PDF',
        url: 'https://drive.proton.me/urls/K1N05RMRX8#tnbvmn6fchXH'
      },
      {
        id: 'book-7',
        ...
        category: 'Livro',
        subType: 'Livros',
        description: 'Política / Revolução / Marxismo - 1917',
        type: 'PDF',
        url: 'https://drive.proton.me/urls/63NHQ3B8Q4#7lTPDLCbo8R4'
      },
      {
        id: 'book-8',
        ...
        category: 'Livro',
        subType: 'Livros',
        description: 'Filosofia / Materialismo histórico - 1932* (publicação póstuma)',
        type: 'PDF',
        url: 'https://drive.proton.me/urls/HGKQKM2XPR#h2cg4tjrGijU'
      },
      {
        id: 'book-9',
        ...
        category: 'Livro',
        subType: 'Livros',
        description: 'Política / Socialismo / Crítica a reformas graduais - 1900',
        type: 'PDF',
        url: 'https://drive.proton.me/urls/7FY33FNQ14#1SbJMJOwjisO'
      },
      {
        id: 'book-10',
        ...
        category: 'Livro',
        subType: 'Livros',
        description: 'Movimento operário / Política sindical - 1906',
        type: 'PDF',
        url: 'https://drive.proton.me/urls/PG8NKM42DM#OTCc8oyo6Bib'
      },
      {
        id: 'book-11',
        ...
        category: 'Livro',
        subType: 'Livros',
        description: 'Filosofia / Sociologia / Crítica social - 1884',
        type: 'PDF',
        url: 'https://drive.proton.me/urls/EBBBR8VARW#iLU7SIAx3kVH'
      },
      {
        id: 'book-12',
        ...
        category: 'Livro',
        subType: 'Livros',
        description: 'Educação / Pedagogia socialista - 1933',
        type: 'PDF',
        url: 'https://drive.proton.me/urls/K1N05RMRX8#tnbvmn6fchXH'
      },
      {
        ...
        category: 'Livro',
        subType: 'Livros',
        description: 'Cordel / Literatura popular / Cultura nordestina - 1959',
        type: 'PDF',
        url: 'https://drive.proton.me/urls/RKD64BYJA0#FDYQ1VgcoFWF'
      },
      {
        id: 'book-14',
        ...
        category: 'Livro',
        subType: 'Livros',
        description: 'Folclore / Literatura popular - Desconhecida',
        type: 'PDF',
        url: 'https://drive.proton.me/urls/EBBBR8VARW#iLU7SIAx3kVH'
      },
      {
        ...
        category: 'Livro',
        subType: 'Livros',
        description: 'Romance psicológico / Crime / Moralidade - 1866',
        type: 'PDF',
        url: 'https://drive.proton.me/urls/FEQ3E4YVWM#kTUbSWhiKARz'
      },
      {
        id: 'book-16',
        ...
        category: 'Livro',
        subType: 'Livros',
        description: 'Literatura modernista / Reflexão subjetiva - 1982* (publicação póstuma)',
        type: 'PDF',
        url: 'https://drive.proton.me/urls/SBZQQ1FWZR#ozSKPVkk4oa1'
      },
      {
        id: 'book-17',
        title: 'Ilíada',
        ...
        category: 'Livro',
        subType: 'Livros',
        description: 'Épico / Mitologia / Guerra de Troia - séc. VIII a.C.',
        type: 'PDF',
        url: 'https://drive.proton.me/urls/D4EB4XYM0W#38LRX92fKn3x'
      }
    ]
  },
  {
    ...
    description: 'Vídeos e conteúdos multimídia.',
    icon: 'fa-video',
    subTypes: ['Vídeos', 'Conteúdos'],
    items: [
      {
        id: 'video-1',
        ...
        subType: 'Vídeos',
        type: 'Vídeo',
        url: 'https://www.youtube.com/embed/BCVkRA69THI',
        embed: true
      },
      {
        id: 'video-2',
        ...
        subType: 'Vídeos',
        type: 'Vídeo',
        url: 'https://www.youtube.com/embed/DN0qoSCJYlI',
        embed: true
      }
    ]
  }
